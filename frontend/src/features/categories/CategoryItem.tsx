...
const buttonSelectCategory = (onSelect: ((id: number) => void) | undefined, category: Category, selected: boolean | undefined) => {
  return <button
    type="button"
...
const buttonEditCategory = (isBusy: boolean | undefined, onEdit: ((id: number) => void) | undefined, category: Category) => {
  return <button
    type="button"
    disabled={isBusy}
...
const buttonDeleteCategory = (isBusy: boolean | undefined, onDelete: ((id: number) => void) | undefined, category: Category) => {
  return   <button
    type="button"
    disabled={isBusy}
